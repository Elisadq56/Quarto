...
# Pietons : tons "froids" + rouge pour le danger, trait plein
pal_pieton <- colorFactor(
  palette = c("Chemin dangereux"   = "#e31a1c",   # rouge vif
              "Voie peu circulee"  = "#1f78b4",   # bleu
              "Chemin correct"     = "#33a02c"),  # vert
  domain = chemin_pieton$categorie
)
 
# Velos : tons "chauds" (orange/brun), trait pointille pour renforcer la distinction
pal_velo <- colorFactor(
  palette = c("Cheminement a amenager"  = "#ff7f00",  # orange
              "Amenagement correct"     = "#b15928",  # brun/gold
              "Chemin non carrossable"  = "#7f0000"), # marron fonce
...
**Caractéristiques :** - Rue résidentielle peu circulée en journée sauf aux heures d’entrée et sortie de collège - Double-sens. - Circulation bus scolaire dans un sens
